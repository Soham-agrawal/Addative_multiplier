...
def multiplier_unified(num_a, num_b, format_select, radix_select, mode_select):
    ...
    if format_select:  # FP16
        ...
        log_sum_r4 = mask(log_sum_r4_pre << 1, 12)
    else:  # bfloat16
        log_a_r4 = (log_approx_a >> 4) & 0x7F
        log_b_r4 = (log_approx_b >> 4) & 0x7F
        log_sum_r4_pre = mask(log_a_r4 + log_b_r4, 8)
        log_sum_r4 = mask(log_sum_r4_pre << 4, 12)
...
if __name__ == "__main__":
    ...
    checks = [
        ("CLM",      0, 0, "FP16", 0.0    ), ("CLM",       0, 0, "bf16", 0.0    ),
